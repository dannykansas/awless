...
import (
	...
	"github.com/thunderbird86/awless/aws/config"
...
var configDefinitions = map[string]*Definition{
	...
	schedulerURL:                   {help: "URL used by awless CLI to interact with pre-installed https://github.com/thunderbird86/awless-scheduler", defaultValue: "http://localhost:8082"},
}
