...
$BIN  run -e smoke_tests/test-all-drivers.aws void.ova-file=$GOPATH/src/github.com/thunderbird86/awless/smoke_tests/test.ova \
cloudformation.policy-file=$GOPATH/src/github.com/thunderbird86/awless/smoke_tests/test-cloudformation.policy \
cloudformation.templatefile=$GOPATH/src/github.com/thunderbird86/awless/smoke_tests/test-cloudformation-sample.template \
lambda.zipfile=$GOPATH/src/github.com/thunderbird86/awless/smoke_tests/test-lambda-function.zip \
